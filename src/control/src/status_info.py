...
class MoveGroupPythonInterfaceTutorial(object):
    ...
    def set_pose_goal(self, t):   
        ...
        pose_goal.orientation.x = -1/np.sqrt(2)
        pose_goal.orientation.y = 0
        pose_goal.orientation.z = 0
        pose_goal.orientation.w = 1/np.sqrt(2)
    ...
    def check_position(self):
        ...
        position = np.array([round(x,4), round(y,4), round(z,4), a, b, c, d])
        return position
    ...
    def check_joint_state(self):
        ...
        a = np.array([round(a0,3),round(a1,3),round(a2,3),round(a3,3)])
        # print("angle:", a)
        return a
...
def main():
    ...
    try:
        while(1):
            ...
            angle = tutorial.check_joint_state()
